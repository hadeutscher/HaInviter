...
pub struct Strings {
    ...
    pub field_file_unreadable: &'static str,
    /// `{}` is the size limit in MB
    pub field_image_too_large: &'static str,
    /// `{}` is the size limit in MB
    pub field_file_too_large: &'static str,
    ...
    pub action_send_whatsapp: &'static str,
    pub action_share: &'static str,
    pub action_mark_unsent: &'static str,
    pub guests_phone: &'static str,
    pub guests_phone_help: &'static str,
    pub guests_sent_at: &'static str,
    pub guests_import_button: &'static str,
    pub guests_importing: &'static str,
    pub guests_import_help: &'static str,
    pub guests_imported: &'static str,
    pub guests_import_no_phone: &'static str,
    ...
    pub err_no_contacts: &'static str,
    pub err_share_failed: &'static str,
    pub err_bad_phone: &'static str,
...
pub static EN: Strings = Strings {
    ...
    field_file_unreadable: "Could not read that file.",
    field_image_too_large: "That image is larger than {} MB.",
    field_file_too_large: "That file is larger than {} MB.",
    ...
    action_send_whatsapp: "Send on WhatsApp",
    action_share: "Share invitation",
    action_mark_unsent: "Mark as not sent",
    guests_phone: "Mobile number",
    guests_phone_help: "Used only to open a chat from the buttons below. Include the country \
                        code, or set HAINVITER_DEFAULT_REGION.",
    guests_sent_at: "sent {}",
    guests_import_button: "Import contacts",
    guests_importing: "Importing…",
    guests_import_help: "Share contacts from your phone as a .vcf file and drop it here. Names \
                         already on the list keep their link; a missing number is filled in.",
    guests_imported: "Found {found} contacts, added {added}.",
    ...
    err_no_contacts: "no contacts found in that file",
    err_share_failed: "could not share or copy that message",
    err_bad_phone: "that does not look like a phone number that can be dialled",
...
pub static HE: Strings = Strings {
    ...
    field_file_unreadable: "לא הצלחנו לקרוא את הקובץ.",
    field_image_too_large: "התמונה גדולה מ־{} מ״ב.",
    field_file_too_large: "הקובץ גדול מ־{} מ״ב.",
    ...
    action_send_whatsapp: "שליחה בוואטסאפ",
    action_share: "שיתוף ההזמנה",
    action_mark_unsent: "סימון כלא נשלח",
    guests_phone: "מספר נייד",
    guests_phone_help: "משמש רק לפתיחת שיחה מהכפתורים שלמטה. הוסיפו קידומת מדינה, או הגדירו \
                        את HAINVITER_DEFAULT_REGION.",
    guests_sent_at: "נשלח {}",
    guests_import_button: "ייבוא אנשי קשר",
    guests_importing: "מייבא…",
    guests_import_help: "שתפו אנשי קשר מהטלפון כקובץ ‎.vcf‎ וגררו אותו לכאן. מי שכבר ברשימה \
                         שומר על הקישור שלו, ומספר חסר מתמלא.",
    guests_imported: "נמצאו {found} אנשי קשר, נוספו {added}.",
    ...
    err_no_contacts: "לא נמצאו אנשי קשר בקובץ",
    err_share_failed: "לא הצלחנו לשתף או להעתיק את ההודעה",
    err_bad_phone: "זה לא נראה כמו מספר טלפון שאפשר לחייג אליו",
