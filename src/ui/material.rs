...
fn icon_path(name: &str) -> &'static str {
    match name {
        ...
        // A round table with a chair on each side.
        "seating" => {
            "M12 6a6 6 0 1 0 0 12 6 6 0 0 0 0-12m0 2a4 4 0 1 1 0 8 4 4 0 0 1 0-8M11 1h2v3h-2zm0 19h2v3h-2zM1 11h3v2H1zm19 0h3v2h-3z"
        }
